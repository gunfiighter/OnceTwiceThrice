...
namespace Tests
{
    ...
    public class SlimletTests
    {
        ...
        public void MoveWithBarrier()
        {
            ...
            game.GoWhileNotStop(Keys.Right, Tuple.Create(2, 2));
            game.GoWhileNotStop(Keys.Left, Tuple.Create(1, 2));
        }
        ...
        public void Spell()
        {
            ...
            Assert.AreEqual(0, game.Model.Map[1, 0].Mobs.Count);
            game.DoTicks(60);
            ...
            game.CreateSpell();
            Assert.AreEqual(1, game.Model.Spells.Count);
            Assert.AreEqual(1, game.Model.Map[1, 2].Mobs.Count);
            ...
            game.DoTicks(100);
            Assert.AreEqual(0, game.Model.Map[2, 1].Items.Count);
        }
    }
}
