...
namespace Tests
{
    ...
    public class MatthiusTests
    {
        ...
        public void Spell()
        {
            ...
            game.Turn(Keys.Left);
            game.CreateSpell();
            Assert.AreEqual(0, game.Model.Map[0, 1].Mobs.Count);
            Assert.AreEqual(1, game.Model.Map[0, 1].Items.Count);
            game.DoTicks(100);
            Assert.AreEqual(0, game.Model.Map[0, 1].Items.Count);

            game.Turn(Keys.Down);
            Assert.AreEqual(0, game.Model.Spells.Count);
            game.CreateSpell();
            Assert.AreEqual(1, game.Model.Spells.Count);
            Assert.AreEqual(0, game.Model.Map[1, 2].Mobs.Count);
